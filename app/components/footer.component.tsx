...
const Footer = () => {
  return (
          <section className=' flex justify-center flex-col items-center text-center gap-4'>
                    ...
                    >
                              <h1 className={`${styles.heroHeadText} `}>Let&apos;s create something together</h1>
                    </motion.div>
                    <motion.p
                    ...
                    >
                                ...
                                If you have any questions or would like to discuss a potential collaboration, please feel free to reach out to me at 
