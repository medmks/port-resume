          ...
          <div className=" w-full flex md:flex-row flex-col justify-start gap-3 mt-7 ">
            ...
            >
              <div className="rounded-full flex justify-center  ">
                <img
                  className="  rounded-full w-10 h-10 lg:w-24 lg:h-24 object-cover shadow-lg shadow-black border-2 border-gray-500"
                  src={
                    "https://media.licdn.com/dms/image/D4E0BAQEo6bReI2rhHw/company-logo_200_200/0/1715944361002/xco_agency_llc_logo?e=2147483647&v=beta&t=9jEdOX0bM6LJWKMv3Tc2AqpvQfszYqSO1ZZnG8_TrQ4"
                  }
                  alt=""
                />
              </div>
