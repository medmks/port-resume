  ...
  return (
    <>
      <motion.button
        ...
        className={
          "  bg-gradient-to-r bg-red-600 mt-2 hover:bg-opacity-75  text-white px-14 p-3 rounded-md w-fit font-outfit font-medium md:text-[28px] sm:text-[22px] xs:text-[22px] text-[22px] "
        }
      >
        Say salam
      </motion.button>
          ...
          <Modal.Body className="bg-zinc-800 ">
            <div className="space-y-6">
              ...
              <div className="w-full">
                <Button color={""} className="w-full bg-red-700 text-white">
                  Send message
                </Button>
              </div>
            </div>
