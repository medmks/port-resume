const styles = {
  ...
  SubHeadText:
    "font-outfit font-normal text-white lg:text-[36px] xs:text-[50px] leading-[40px] text-[32px] lg:leading-[42px] ",
  heroSubText:
    "text-red-100 font-outfit font-semibold lg:text-[32px] sm:text-[26px]  xs:text-[20px] text-[24px] lg:leading-[42px] ",
  sublink:
    "text-white font-outfit font-medium lg:text-[24px] sm:text-[18px]  xs:text-[20px] text-[20px] lg:leading-[25px] ",
  sectionHeadText:
    "font-outfit text-white font-semibold  md:text-[30px] sm:text-[30px] xs:text-[40px] text-[28px]",
  roletext:
    "font-outfit text-white font-normal  md:text-[24px] sm:text-[24px] xs:text-[28px] text-[20px]",
  // sectionSubText:
