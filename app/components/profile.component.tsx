      ...
      <div className="relative w-full  mx-auto  ">
        <div className=" w-full flex md:flex-row flex-col justify-start gap-5 ">
          ...
          <div className="flex flex-col w-fit gap-2 text-center md:text-left ">
            ...
            <motion.div variants={textVariant(1.3)} className=" ">
              <p
                className={`${styles.sectionSubText} w-fit min-w-64 whitespace-normal      `}
              >
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aut
                earum, perferendis nam molestiae odio saepe.
              </p>
            </motion.div>
          </div>
        </div>
